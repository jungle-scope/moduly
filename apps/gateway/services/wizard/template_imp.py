...
TEMPLATE_PROVIDER_EFFICIENT_MODELS = {
    "openai": "gpt-4o-mini",
...
async def improve_template(
    ...
    try:
        model_id = select_model(
            db, credential, TEMPLATE_PROVIDER_EFFICIENT_MODELS, "템플릿 마법사"
        )
        ...
        improved_template = parse_llm_response(response)

        # [Safety Logic] Jinja2 syntax fix
