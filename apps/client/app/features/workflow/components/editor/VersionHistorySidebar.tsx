...
export function VersionHistorySidebar() {
  ...
  return (
    <div className="absolute top-28 right-0 bottom-0 w-80 bg-white border-l border-gray-200 shadow-xl z-40 flex flex-col animate-in slide-in-from-right duration-200">
      {/* 헤더 */}
