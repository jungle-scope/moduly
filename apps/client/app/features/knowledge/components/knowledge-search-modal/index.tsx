        ...
        try {
          ...
          if (res.ok) {
            ...
            if (chatModels.length > 0) {
              const defaultModel = chatModels.find((m: any) => m.model_id_for_api_call.includes('gpt-4o')) || chatModels[0];
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
          <div className="relative max-w-4xl mx-auto">
            <textarea
              ...
              placeholder={activeTab === 'search' ? "검색어를 입력하세요..." : "지식 베이스에 대해 질문해보세요..."}
            ...
            <button
              ...
              disabled={isLoading || !query.trim() || (activeTab === 'chat' && !selectedModelId && modelOptions.length > 0)}
